...
bd create --title="Port sixel tests from Go to Crystal spec" --type=task --priority=2
bd create --title="Port color tests from Go to Crystal spec" --type=task --priority=2
bd create --title="Port image tests from Go to Crystal spec" --type=task --priority=2
...
This is a Crystal port of the Go code from `./x/ansi`. Follow Crystal idioms and best practices:
